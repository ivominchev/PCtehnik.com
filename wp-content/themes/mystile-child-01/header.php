...
<html lang="bg">
<title><?php woo_title(''); ?> | <?php bloginfo('name'); ?></title>
<?php woo_meta(); ?>
<link rel="stylesheet" type="text/css" href="wp-content/themes/mystile-child-01/style.css" media="screen" />
