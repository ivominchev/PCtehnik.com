...
?>
	...
	<table>
				<td><div class="company-info">
						<h2>Сервиз за компютри и офис техника PCtehnik</h2>
						<h3>Сметало ЕООД</h3>
		...
		<td><div class="order-branding">
					<div class="company-logo">
						<?php if( wcdn_get_company_logo_id() ) : ?><?php wcdn_company_logo(); ?><?php endif; ?>
					<?php do_action( 'wcdn_after_branding', $order ); ?>
				</div><!-- .order-branding --></div></td>
	</table>

	<table>
	<td><img src="http://pctehnik.com/wp-content/uploads/Signal_attention.png" alt="Внимание!!!" /></td>
	<td><div class="page-follow">Можете да наблюдавате ПОДРОБНО статуса и коментарите за Вашата поръчка на страницата www.PCtehnik.com, в секция <a href="http://pctehnik.com/magazin/prosledi-porachka/">"Проследи поръчка"</a>, като въведете ID на заявката (<?php echo __( 'Order:', 'woocommerce' ) . ' ' . $order->get_order_number(); ?>) и email адреса посочен в нея (<?php echo $order->billing_email; ?>).</div></td>
	</table>
	<p><br></p>
