...
class WC_Order_Status_Manager_Order_Statuses {
	 ...
	 *
	 * TODO remove as part of WC 2.7 compatibility update {FN 2016-06-14}
	 *
	...
	public function is_download_permitted( $maybe_permitted, $order ) {
		_deprecated_function( 'WC_Order_Status_Manager_Order_Statuses::is_download_permitted()', '1.5.1', 'WC_Order_Status_Manager::is_download_permitted()' );
