                            ...
                            <div class="form-group" style="border-top: 1px solid #eee;">
                                ...
                                <div class="col-sm-10 perms_group" id="user_permissions">
                                    ...
                                    <div class="perms_group"><?php _e( 'Products', 'mobile-assistant-connector' ); ?><br/>
                                        ...
                                        <label class="perms_label"><input type="checkbox" id="user_allowed_actions_product_edit" name="user_allowed_actions[product_edit]" class="perms perm_product_list_child" value="0" > <?php _e( 'Product editing', 'mobile-assistant-connector' ); ?></label><br/>
                                        <label class="perms_label"><input type="checkbox" id="user_allowed_actions_product_add" name="user_allowed_actions[product_add]" class="perms perm_product_list_child" value="0" > <?php _e( 'Product adding', 'mobile-assistant-connector' ); ?></label><br/>
                                    </div>
                                </div>
                            </div>
