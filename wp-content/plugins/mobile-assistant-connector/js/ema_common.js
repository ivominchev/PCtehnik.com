        ...
        if (user_id) {
            ...
            $jQema.post(ajaxurl,
                ...
                function (data) {
                    ...
                    var t_user_product_edit = $jQema('#user_allowed_actions_product_edit');
                    var t_user_product_add = $jQema('#user_allowed_actions_product_add');
                    ...
                    if (data != 'error' && data != 'Authentication error') {
                        ...
                        $jQema.each(data, function (index, values) {
                            ...
                            if (values.allowed_actions.indexOf("product_edit") >= 0) {
                                t_user_product_edit.prop('checked', true);
                            }
                            if (values.allowed_actions.indexOf("product_add") >= 0) {
                                t_user_product_add.prop('checked', true);
                            }
