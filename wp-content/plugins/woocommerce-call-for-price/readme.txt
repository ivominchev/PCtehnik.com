...
Tags: woocommerce, call for price, wpfactory
...
Call for Price for WooCommerce plugin extends WooCommerce by outputting "Call for Price" when price field for product is left empty. You can additionally change the default add to cart button text for products with empty price.
